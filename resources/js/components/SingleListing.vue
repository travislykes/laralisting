    ...
    <div>
      <div class="subheader subheader-two">
        <div class="subheader-two-block">
          ...
          <p>We Ensure Dreammy Environment</p>
          <ul>
            <li>
              <p>
                <i class="fa fa-map-marker" aria-hidden="true"></i> 215 College Street, California, CA758423
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <i class="fa fa-envelope-o" aria-hidden="true"></i> nfo@example.com
              </p>
            </li>
          </ul>
        </div>
      ...
      <div class="breadcrumb-block">
        <div class="container">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="favorite-listing.html">Restaurant </a></li>
            <li class="breadcrumb-item active">Hotel California</li>
          </ol>
